...
public class InfoOverlayCamera extends Entity implements Camera {
	...
	public void initialize(final Cobra2DEngine engine) throws EntityInitializeException {
		...
		this.fpsMeter = new AverageMeter(new Dimension(this.meterDefaultWidth, this.meterDefaultHeight), "FPS", 0, 100,
				new Point(0, 0));
		this.upsMeter = new AverageMeter(new Dimension(this.meterDefaultWidth, this.meterDefaultHeight), "UPS", 0, 100,
				new Point(0, 0));
		this.statusMeter = new StatusMeter(new Dimension(this.meterDefaultWidth, this.meterDefaultHeight),
				new Point(0, 0));
	...
	public void render(final Graphics2D graphics) {
		...
		this.drawText("Update time: " + updateTime + "ms", graphics, 140, 45);
		this.drawText("Render time: " + renderTime + "ms", graphics, 280, 45);
		this.drawText("FPS: " + this.engine.getActualFPS() + "fps", graphics, 420, 45);
